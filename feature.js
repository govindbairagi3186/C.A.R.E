...
(function () {
    ...
    const ICONS = {
        ...
        "Pothole": '<i class="fa-solid fa-circle-dot"></i>',

        "Road Damage": '<i class="fa-solid fa-triangle-exclamation"></i>',

        "Garbage": '<i class="fa-solid fa-trash-can"></i>',

        "Streetlight": '<i class="fa-solid fa-lightbulb"></i>',

        "Drainage": '<i class="fa-solid fa-water"></i>',

        "Water": '<i class="fa-solid fa-droplet"></i>',

        "Other": '<i class="fa-solid fa-location-dot"></i>'
            ...
            >
                ...
                ${
                    ...
                    >
                        ...
                        <i class="fa-solid fa-clipboard-list" style="font-size: 32px; color: var(--care-blue); display: block; margin-bottom: 12px;"></i>
    ...
    function showReportDetail(
        ...
        openPanel(
            ...
            <h3>
                <i class="fa-solid fa-clock-rotate-left"></i> Status Timeline
            </h3>
            ...
            >
                ...
                ${
                    ...
                    '<i class="fa-solid fa-circle-check" style="color: #16a34a;"></i> This civic issue has been resolved.'

                    :

                    '<i class="fa-solid fa-arrows-rotate" style="color: #0b5ed7;"></i> Municipal updates will appear here automatically.'
        ...
        try {
                    ...
                    .getCurrentPosition(
                        ...
                        position => {
                            ...
                            L.circleMarker(
                                ...
                                .bindPopup(
                                    '<i class="fa-solid fa-location-dot"></i> Your current location'
                                )
            ...
            document.getElementById(
                ...
                >
                    ...
                    <i class="fa-solid fa-circle-xmark" style="font-size: 32px; color: #ef4444; display: block; margin-bottom: 12px;"></i>
    ...
    function addNavigation() {
        ...
        mapButton.innerHTML =
            '<i class="fa-solid fa-map-location-dot"></i> Civic Map';
        ...
        trackingButton.innerHTML =
            '<i class="fa-solid fa-chart-column"></i> My Reports';
    ...
    function addAdminLink() {
        ...
        link.innerHTML =
            '<i class="fa-solid fa-shield-halved"></i> Municipal Control Center';
